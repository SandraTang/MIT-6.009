...
#     if ('highway' in node['tags'] and node['tags']['highway'] in ALLOWED_HIGHWAY_TYPES):
#             print(node)
    # if 'highway' in node['tags']:
    #         print(('highway' in node['tags']), node['tags'])
    # if node['id'] == 233941454:
    #     print("node1:", (node['lat'], node['lon']))
    # if node['id'] == 233947199:
    #     print("node2:", (node['lat'], node['lon']))
    # if 'oneway' in node['tags'] and node['tags']['oneway'] == 'yes':
    #     print(node['id'])
        # counter += 1
# print(counter)