...
class TestTiny(unittest.TestCase):
    ...
    def test_acting_together(self):
        self.assertEqual(lab.acted_together(self.data, 4724, 1532), True)

    def test_bacon_number_0(self):
        n = 0
        self.assertEqual(lab.actors_with_bacon_number(self.data, n), {4724})

    def test_bacon_number_1(self):
        n = 1
        self.assertEqual(lab.actors_with_bacon_number(self.data, n), {2876, 1532})

    def test_bacon_number_2(self):
        n = 2
        self.assertEqual(lab.actors_with_bacon_number(self.data, n), {1640})

    def test_bacon_number_3(self):
        n = 3
        self.assertEqual(lab.actors_with_bacon_number(self.data, n), set())

    def test_bacon_path_number_4(self):
        self.assertEqual(lab.bacon_path(self.data, 1640), [4724, 2876, 1640])

    def test_actor_to_actor_path_number_5(self):
        self.assertEqual(lab.actor_to_actor_path(self.data, 2876, 1640), [2876, 1640])
...
class Test03_BaconPath(unittest.TestCase):
    ...
    def test_bacon_path_0(self):
        actor_id = 1640
        expected = [4724, 2876, 1640]
        filename = 'resources/tiny.pickle'
        with open(filename, 'rb') as f:
            data = pickle.load(f)
        zero_result = lab.bacon_path(data, actor_id)
        self.assertTrue(zero_result, expected)
